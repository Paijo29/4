  ...
  <body bgcolor='black' style='margin:0' oncontextmenu='return false' onkeydown='return false'
    ...
    <script>
      async function init() {
        ...
        player.configure({
          drm: {
            clearKeys: {
              ...
              'ce37e20374e55be6bb4d26837af27605': '52cc532f748fcbf2b806dad4289bf84c'
            }
          }
        });
        ...
        try {
          await player.load('https://director.streaming.telia.com/tvm-packager-prod/group1/60896dfd47a23d7c065cd68c/manifest.mpd');
